// <copyright file="UIController.cs" company="ST-Apps (S. Tenuta)">
...
public class UIController : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        ...
        if (ModSettings.KeyToggleTool.IsPressed(e))
        {
            ToggleModStatus();
        }

        if (ModSettings.KeyIncreaseHorizontalOffset.IsPressed(e))
        {
            AdjustNetOffset(1f);
        }

        if (ModSettings.KeyDecreaseHorizontalOffset.IsPressed(e))
        {
            AdjustNetOffset(-1f);
        }

        if (ModSettings.KeyIncreaseVerticalOffset.IsPressed(e))
        {
            AdjustNetOffset(1f, false);
        }

        if (ModSettings.KeyDecreaseVerticalOffset.IsPressed(e))
        {
            AdjustNetOffset(-1f, false);
        }
